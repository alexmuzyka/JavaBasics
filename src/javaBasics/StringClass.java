...
public class StringClass {
	...
	public static void main(String[] args) {
		...
		StringTestExerciseLength();

		System.out.println(newLine + "Concatenating String:");
		StringTestExerciseConcatenating();

		System.out.println(newLine + "Various String Methods:");
		StringTestExerciseMethods();

	}

	private static void StringTestExerciseMethods() {
	...
	private static void StringTestExerciseConcatenating() {
	...
	private static void StringTestExerciseLength() {
